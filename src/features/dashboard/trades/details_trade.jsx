...
import trxImg from "../transactions/details/transactions.svg"
...
const DetailsTrade = ({ data, openJSON }) => {
	...
	if (!data.time) {
		return (
			<div className={classes.rootDetailsTradeNoData}>
				...
				<p className={classes.textNoData}>Select a transaction to see the detailsTrade</p>
			</div>
		)
	}
	...
	return (
		<div className={classes.rootDetailsTrade}>
			<div className={classes.detailsTradeContainer}>
