				...
				<div className="p-2">
					<div className="flex justify-between my-2">
						...
						<CloseSvg
							...
							className="hover:stroke-white-full stroke-wosmongton-400 cursor-pointer transition-colors duration-default"
						/>
					</div>
					<div
						className="p-3 my-3 bg-osmosverse-900 rounded-2xl flex cursor-pointer hover:bg-wosmongton-700 transition-colors duration-default"
					...
					<div
						className="p-3 mt-3 bg-osmosverse-900 rounded-2xl flex cursor-pointer hover:bg-wosmongton-700 transition-colors duration-default"
